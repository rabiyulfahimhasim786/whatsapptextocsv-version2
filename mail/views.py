...
from .models import EmailModel, Totalexperience
from .serializers import Totalexperienceserializers
from rest_framework.generics import (ListCreateAPIView, RetrieveUpdateDestroyAPIView)

#total experience api view
class experienceListView(ListCreateAPIView):
    queryset = Totalexperience.objects.all()
    serializer_class = Totalexperienceserializers

class expericeUpdateDeleteApiView(RetrieveUpdateDestroyAPIView):
    queryset = Totalexperience.objects.all()
    serializer_class = Totalexperienceserializers
...
def emailscraper(request):
    try:
        username = "rabiyul@desss.com"
        password = "!DESSs#05051997$"
