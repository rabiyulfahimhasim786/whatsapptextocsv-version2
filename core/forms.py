...
from . models import whatsapp,Film, Emailbenchsales, Emailleadoppurtunities, Emailsample, Customleads, Custombench, CustomizeEmailLeads, CustomizeBenchsalesLeads, Customemailleads, Custombenchsales
...
class CustombenchForm(forms.ModelForm):
    class Meta:
        model=Custombench
        fields="__all__"